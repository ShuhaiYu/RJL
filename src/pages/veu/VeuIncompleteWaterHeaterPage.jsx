// src/pages/veu/VeuIncompleteWaterHeaterPage.jsx
...
export default function VeuIncompleteWaterHeaterPage() {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="flex items-center justify-center w-12 h-12 bg-primary-100 rounded-lg">
            <KeenIcon icon="drop" className="text-2xl text-primary-600" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-gray-900">
              Incomplete Water Heater
              {agencyNameFromState ? ` - ${agencyNameFromState}` : ""}
            </h1>
            <p className="text-gray-600">Properties with incomplete water heater</p>
          </div>
        </div>
      </div>
